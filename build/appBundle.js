 ...
 * CLI version: 2.14.2
 * 
 * Generated: Fri, 11 Jul 2025 16:48:51 GMT
 */
...
var APP_com_domain_app_CTVApp = (function () {
  ...
  class Thumbnail extends Lightning$1.Component {
    static _template() {
      return {
        w: 300,
        h: 200,
  ...
  class Details extends Lightning$1.Component {
    static _template() {
      return {
        Background: {
          rect: true,
    ...
    set params(selectedMovie) {
      this.tag('Title').text.text = selectedMovie === null || selectedMovie === void 0 ? void 0 : selectedMovie.title;
      this.tag('Background.Image').src = selectedMovie === null || selectedMovie === void 0 ? void 0 : selectedMovie.img;
    }
  }
